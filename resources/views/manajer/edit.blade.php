       ...
       <form action="{{ route('manajer.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
          <div class="mb-3 row">
            ...
            <div class="col-sm-8">
              <input type="text" name="nama_menu" class="form-control" id="" placeholder=""  value="{{ $manajer->nama_menu }}">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-8">
              <input type="text" name="harga" class="form-control" id="" placeholder="" value="{{ $manajer->harga }}">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-8">
                <textarea class="form-control" name="deskripsi" id="exampleFormControlTextarea1" rows="3" >{{ $manajer->deskripsi }}"</textarea>
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-8">
              <input type="number" name="ketersediaan" class="form-control" id="" placeholder="" value="{{ $manajer->ketersediaan }}">
            </div>
